...
The `Marker` component displays conversation markers such as status updates, system notes, bordered rows, and labeled separators. Compose it with [`Message`](/components/base/Message) in a conversation thread.
...
<ComponentSource name="Marker" title="components/ui/Marker.res" />
